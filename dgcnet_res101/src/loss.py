...
class CriterionOhemDSN(nn.Cell):
    ...
    def construct(self, image, target):
        ...
        resize1 = mindspore.ops.ResizeBilinearV2(align_corners=True)
        scale_pred = resize1(preds[0], (self.h, self.w))  # (1, 19, 832, 832)
        loss1 = self.criterion1(scale_pred, target)
        scale_pred = resize1(preds[1], (self.h, self.w))  # (1, 19, 832, 832)

...
class Merge(nn.Cell):
    ...
    def construct(self, x, f1, f2, f3, f4):
        ...
        out = P.ResizeBilinearV2(True)(f4, (img_hight / 16, img_width / 16))
        out = self.concat((out, f3))
        out = self.relu1(self.bn1(self.conv1(out)))
        out = self.relu2(self.bn2(self.conv2(out)))

        out = P.ResizeBilinearV2(True)(out, (img_hight / 8, img_width / 8))
        out = self.concat((out, f2))
        out = self.relu3(self.bn3(self.conv3(out)))
        out = self.relu4(self.bn4(self.conv4(out)))

        out = P.ResizeBilinearV2(True)(out, (img_hight / 4, img_width / 4))

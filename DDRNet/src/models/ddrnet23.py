...
class DualResNet(nn.Cell):
    ...
    def __init__(self, block, layers, num_classes=1000, planes=64, last_planes=2048, image_size=224, drop_path_rate=0.):
        ...
        self.resize_1 = ops.ResizeBilinearV2()
        self.resize_2 = ops.ResizeBilinearV2()
        self.weigit_init()
    ...
    def construct(self, x):
        ...
        x_ = x_ + self.resize_1(self.compression3(self.relu(layer3_out)), (self.width_output, self.height_output))
        layer4_out = self.layer4(self.relu(x))
        x_ = self.layer4_(self.relu(x_))

        x = layer4_out + self.down4(self.relu(x_))
        x_ = x_ + self.resize_2(self.compression4(self.relu(layer4_out)), (self.width_output, self.height_output))
